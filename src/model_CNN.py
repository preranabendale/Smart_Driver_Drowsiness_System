...
path1 = 'C:Users/prera/OneDrive/Desktop/24c9501-Driver Drowsiness detection system/24c9501-Driver Drowsiness detection system/100% code/yawn'    #path of folder of images    
