...
def Drowsiness():
    ...
    path = r"classifiers/haar-face.xml"#pretrain model 
...
button1 = tk.Button(root, text="Drowsiness Detection", command=Drowsiness, width=25, height=2, bd=0,
                    background="#B0E0E6", foreground="black", font=("Times New Roman", 17, "bold"))
button1.place(x=50, y=200)



# Exit Button
button3 = tk.Button(root, text="Exit", command=Exit, width=25, height=2, bd=0,
                    background="#B0E0E6", foreground="black", font=("Times New Roman", 17, "bold"))
